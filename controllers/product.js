...
exports.remove = ( req , res )=>{
     ...
     product.remove( (err, deletedProduct) =>{
      ...
      res.json({
        deletedProduct,
        "Message":"Prdduct was deleted successfully"
      })
     });
}
...
exports.list=(req, res) => {
  ...
  let limit=req.query.limit? parseInt(req.query.limit) : 10;
   ...
   Product.find()
          .select('-photo') //de-select photo field
          .populate('category')
          .sort([[sortBy,order]])
          .limit(limit)
          .exec((err , products) =>{
    ...
    /**
     * find the category of the produt 
     * list products depending on this category
     */ 
    ...
    // list categories that has products to
...
exports.listSearch = (req, res) => {
  ...
  if (req.query.search) {
      ...
      // search and category
      console.log('query from sever ',query);
